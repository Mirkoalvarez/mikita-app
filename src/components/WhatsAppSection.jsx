    ...
    <section className="px-4 mt-6 pb-8 animate-fade-in">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="w-full py-4 rounded-2xl bg-[#25D366] text-white font-bold text-base flex items-center justify-center gap-2 shadow-lg shadow-[#25D366]/30 hover:bg-[#20BD5A] active:scale-[0.98] transition-all min-h-[52px]"
        >
